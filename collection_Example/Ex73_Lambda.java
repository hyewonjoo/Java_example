...
public class Ex73_Lambda {
	...
	public static void main(String[] args) {
		...
		// 1.
		// 오름차순 정렬 -> Anonymous 클래스 활용 - Comparator
		...
		// 절대경로에서 파일 읽은뒤, 컬렉션에 다시 넣어주기
		try {

			BufferedReader reader =
					new BufferedReader(new FileReader("C:\\Education\\Java_example\\user.txt"));
